...
export default function SignIn() {
    ...
    */
    ...
    const handleGoogleSignIn = () => {
        const googleAuthURL = "https://accounts.google.com/o/oauth2/v2/auth"
        const redirectURI = "http://localhost:4444/auth/google/callback" // Update as needed
        const clientID = "1077788355344-etr9ea1c7m6bl4n92fffoohg6pd7na3s.apps.googleusercontent.com"
    ...
    const handleGitHubSignIn = () => {
        ...
        const clientID = "Ov23liUARmSF7VOPBhn8"; // Replace with your GitHub Client ID
